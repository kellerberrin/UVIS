...
public final class ResultHandlerFactory {
  ...
  public static ResultHandler makeResultHandler(CaptureActivity activity, Result rawResult) {
	...
	switch (result.getType()) {
      case GTIN:
        return new GTINResultHandler(activity, result);
      case VAINT:
        return new VaintResultHandler(activity, result);  
      case ADDRESSBOOK:
  ...
  private static ParsedResult parseResult(Result rawResult) {
	...
	Log.d(ResultHandlerFactory.class.getSimpleName(), "ResultParser.parseResult called");	  	  
