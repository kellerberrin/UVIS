...
*
*
* Material Style Drop Down Memu
*
*
************************************************************************************************/

			
    function k_DropDown(el) {

	    this.dropdownwrapper = el;
		this.placeholder = this.dropdownwrapper.find('span');
		this.opts = this.dropdownwrapper.find('ul.dropdown > li');
		this.val = '';
		this.index = 0;
		this.initEvents();
	...
	k_DropDown.prototype = {

	    initEvents : function() {
		
		    var obj = this;

			obj.dropdownwrapper.on('click', function(event) {
	        ...
	        $(document).on('click', function() {
			    ...
			    obj.dropdownwrapper.removeClass('active');
